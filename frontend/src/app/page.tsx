        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="flex flex-col items-start text-left max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <Link href="/predict" className="h-12 px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded text-sm transition-colors flex items-center justify-center gap-2">
                TRY PREDICTION
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
              </Link>
              <Link href="/analytics" className="h-12 px-8 bg-transparent border border-border hover:bg-muted/50 text-foreground font-semibold rounded text-sm transition-colors flex items-center justify-center gap-2">
                VIEW ANALYTICS
